    ...
    fn aggregated_rangeproof_helper(n: usize, c: &mut Criterion) {
        ...
        c.bench_function_over_inputs(
            ...
            move |b, &&m| {
                ...
                let r_vec = (0..m).map(|_i| Scalar::<Secp256k1>::random()).collect::<Vec<Scalar::<Secp256k1>>>();
...
mod bench_wip_range_proof {
    ...
    use criterion::Criterion;
    use curv::arithmetic::traits::*;
    use curv::elliptic::curves::secp256_k1::Scalar::<Secp256k1>;
    use curv::elliptic::curves::secp256_k1::Point<Secp256k1>;
